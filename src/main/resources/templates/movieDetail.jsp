...
<div class="container bg-faded">
    ...
    <div class="progress">
  		<div class="progress-bar bg-success" role="progressbar" th:style="${currentMovie.getAverageStyle()}" th:aria-valuenow="${currentMovie.getVoteAverage()}" aria-valuemin="0" aria-valuemax="60"></div>
	</div>
    <div class="row">
