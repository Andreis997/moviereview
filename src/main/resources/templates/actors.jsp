...
<body>
	...
	<h1 style="text-align: center">Top trending actors</h1>
	<div class="container">
		<div class="row">
			<div class="col-md-4 d-flex align-items-stretch"
				th:each="actor: ${actors}">
				<div class="card">
						 <img th:src="${actor.getProfile_path()}" alt="Actor" style="width: 100%" class="card-img-top">
						<div class="card-body container">
							<br>
							<h5 class="card-title" th:text="${actor.getName()}"></h5>
							<h6 class="card-subtitle mb-2 text-muted"
								th:text="${actor.getKnown_for_department()}"></h6>
						</div>
				</div>
			</div>
		</div>
